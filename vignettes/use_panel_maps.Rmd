...
Motivating example: \* you have nominal and real gdp values, and want to apply the same concordance to both series

Solution: \* use LONG format! \* pivot_longer \> apply map \> pivot_wider
...
TODO: Example of how to use multi-column key instead of "code_in"; e.g. unique panel map for each country or year? // EAST & WEST Germany GDP data
...
## Dealing with Missing Values at Aggregration
...
<!--# TODO: add demo code for missingness -->
