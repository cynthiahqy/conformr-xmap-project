...
has_coverage <- function(.data, .map, code_in, code_out){
  missing_links <- .data |>
    ...
    dplyr::anti_join(.map, by = rlang::as_name(rlang::enquo(code_in)))
...
testthat::test_that(
  ...
  {
    ## complete coverage
    testthat::expect_false(has_coverage(equal_pm$data_A, equal_pm$pm_BA, std_A, std_B))
