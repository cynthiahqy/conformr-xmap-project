...
In addition to the **coverage requirement**, there are few additional conditions that should be checked to avoid any unexpected data loss or modification:
...
```{r}
raw_abs_pop <- readxl::read_xlsx("data-raw/abs-population_2022.xlsx",
