...
To illustrate, consider the following imperative code for transforming $\bf{x}$ into the target nomenclature:
...
### Comparison to Existing Crosswalk approaches
...
All crossmaps transformations can be decomposed into multiple "standard" transformation steps:
