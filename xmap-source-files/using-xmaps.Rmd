...
Notice that in the nested form, we can see that nomenclature datasets can be thought of mixture of long and wide form. In particular, the format is suitable for cases where the nomenclature variable:

a.  has too many category nodes for wide format,
b.  and/or subject to ex-post harmonisation
