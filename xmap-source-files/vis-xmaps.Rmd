...
This article provides a few ggplot2 code examples for visualising crossmaps. If there is sufficient interest, I might also publish wrapper functions for producing these plots in a ggplot2 extension package.
