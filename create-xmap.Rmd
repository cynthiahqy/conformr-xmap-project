...
usethis::create_package(
  ...
  fields = list(
    ...
    Version = "0.0.0.9020",
    Title = "xmap: A principled approach to recoding and redistributing data between nomenclature",
...
#' 
#' @examples
add_weights_equal <- function(pairs, from, to, weights_into = "weights"){
  ## TODO: validate_pairs_unique()
  pairs |>
    dplyr::group_by({{from}}) |>
...
#' @param tol numeric $\ge$ 0. Ignore differences smaller than `tol`.
