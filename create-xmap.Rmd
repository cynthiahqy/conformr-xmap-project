...
xmap_to_matrix.xmap_df <- function(x, sparse = TRUE){
  ...
  if(sparse){
    x_mtx <- stats::xtabs(stats::as.formula(fm), x_df, sparse = TRUE)
  } else {
    x_mtx <- stats::xtabs(stats::as.formula(fm), x_df, sparse = FALSE)
