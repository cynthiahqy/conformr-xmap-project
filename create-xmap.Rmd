...
df_check_cols <- function(df, col_attrs) {
  ...
  if (length(missing_cols) != 0) {
    cli::cli_abort(
      message = "The column{?s} {.arg {missing_cols}} {?was/were} not found.",
...
## dimension check
testthat::test_that(
  "validate_xmap_df() rejects too few/many columns",
  {
    ...
    testthat::expect_error(df_check_ncol3(big_x), class = "abort_ncol3")
    testthat::expect_error(df_check_ncol3(little_x), class = "abort_ncol3")
    testthat::expect_error(validate_xmap_df(big_x), class = "abort_ncol3")
    testthat::expect_error(validate_xmap_df(little_x), class = "abort_ncol3")
  }
)
