...
#'
#' @export
summary_by_target <- function(links, from, to, weights, composition_to, collapse, frac_formula, unit_formula) {
...
summary_by_target.data.frame <- function(links, from, to, weights,
  ...
  comp_col <- englue_xmap(composition_to, col_from, col_to, col_weights)
  ## summarise
  links |>
